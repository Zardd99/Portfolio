...
const Projects = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white w-screen">
      ...
      <div
        ref={heroSectionRef}
        className="relative overflow-hidden bg-gradient-to-br from-gray-900 via-purple-900/20 to-gray-900"
      >
      ...
      {/* Projects Container */}
      <div className="xl:max-w-xl lg:max-w-lg 2xl:max-w-3xl md:ml-10 lg:ml-30 xl:ml-50 px-4 sm:px-6 lg:px-8 py-12 container">
        <div
          ref={projectsGridRef}
      ...
      {/* Contact Section */}
      <div
        className="mt-20 bg-gradient-to-r from-gray-800/50 to-purple-900/20 backdrop-blur-sm rounded-2xl border border-gray-700/50 p-8 container mx-auto"
        ref={contactRef}
      >
